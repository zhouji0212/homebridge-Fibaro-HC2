...
export class ShadowAccessory {
  ...
  static createShadowAccessory(
    ...
    switch (device.type) {
      ...
      case "com.fibaro.baseShutter":
        ss = [
          new ShadowService(new hapService.GarageDoorOpener(device.name), [
      ...
      case "com.fibaro.motionSensor":
        ss = [
          new ShadowService(new hapService.MotionSensor(device.name), [
      ...
      case "com.fibaro.temperatureSensor":
        ss = [
          new ShadowService(new hapService.TemperatureSensor(device.name), [
      ...
      case "com.fibaro.humiditySensor":
        ss = [
          new ShadowService(new hapService.HumiditySensor(device.name), [
      ...
      case "com.fibaro.satelZone":
        ss = [
          new ShadowService(new hapService.ContactSensor(device.name), [
      ...
      case "com.fibaro.floodSensor":
        ss = [
          new ShadowService(new hapService.LeakSensor(device.name), [
      ...
      case "com.fibaro.smokeSensor":
        ss = [
          new ShadowService(new hapService.SmokeSensor(device.name), [
      ...
      case "com.fibaro.FGCD001":
        ss = [
          new ShadowService(new hapService.CarbonMonoxideSensor(device.name), [
      ...
      case "com.fibaro.lightSensor":
        ss = [
          new ShadowService(new hapService.LightSensor(device.name), [
      ...
      case "com.fibaro.FGWOEF011":
        ss = [
          new ShadowService(new hapService.Outlet(device.name), [
            hapCharacteristic.On,
      ...
      case "com.fibaro.gerda":
        ss = [
          new ShadowService(new hapService.LockMechanism(device.name), [
            hapCharacteristic.LockCurrentState,
            hapCharacteristic.LockTargetState,
          ]),
        ];
        ...
        for (let r = 0; r < device.properties.rows.length; r++) {
          if (device.properties.rows[r].type == "button") {
            for (
              ...
              pushButtonService = new ShadowService(
    ...
    if (device.interfaces && device.interfaces.includes("battery")) {
      ss.push(
        new ShadowService(new hapService.BatteryService(device.name), [
          hapCharacteristic.BatteryLevel,
  ...
  static createShadowGlobalVariableSwitchAccessory(
    ...
    let service = new ShadowService(new hapService.Switch(device.name), [
      hapCharacteristic.On,
    ]);
